...
/*package*/ class State_Diagrammatic_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public State_Diagrammatic_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramNode_0(final EditorContext editorContext, final SNode node) {
    ...
    ContextVariables.withValue("thisNode", node, new Runnable() {
      public void run() {
        ...
        final IShape shape = new StateNodeShape(SPropertyOperations.getBoolean(((SNode) _variablesContext.getValue("thisNode")), PROPS.isInitial$M2fk), SPropertyOperations.getBoolean(((SNode) _variablesContext.getValue("thisNode")), PROPS.isFinal$44KG));
        ...
        editorCell.value.setCellId("DiagramNode_8xtf6z_a");
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_8xtf6z_a0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_8xtf6z_a0a");
    if (nodeCondition_8xtf6z_a0a0a()) {
      editorCell.addEditorCell(createConstant_0());
    }
    editorCell.addEditorCell(createConstant_1());
    editorCell.addEditorCell(createProperty_0());
    if (nodeCondition_8xtf6z_a3a0a()) {
      editorCell.addEditorCell(createConstant_2());
    }
    return editorCell;
  }
  private boolean nodeCondition_8xtf6z_a0a0a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isInitial$M2fk);
  }
  private boolean nodeCondition_8xtf6z_a3a0a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.isFinal$44KG);
  }
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "⚫🠪");
    editorCell.setCellId("Constant_8xtf6z_a0a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "State");
    editorCell.setCellId("Constant_8xtf6z_b0a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createConstant_2() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "🠪⦿");
    editorCell.setCellId("Constant_8xtf6z_d0a0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createHorizontalLineCell_0(EditorContext editorContext, SNode node) {
    ...
    editorCell.setCellId("HorizontalLineCell_8xtf6z_b0a");
  ...
  private EditorCell createComponent_0() {
    EditorCell editorCell = getCellFactory().createEditorComponentCell(myNode, "com.dslfoundry.statemachine.editor.StateMachineDiagramContents");
    return editorCell;
  }
