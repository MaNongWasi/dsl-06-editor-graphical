...
/*package*/ class State_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createComponent_0() {
    EditorCell editorCell = getCellFactory().createEditorComponentCell(myNode, "com.dslfoundry.statemachine.editor.StateMachineTextContents");
    Style style = new StyleImpl();
  ...
  private EditorCell createConstant_4() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "End State");
