...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  private Collection<ConceptEditorHint> myHints = Arrays.<ConceptEditorHint>asList(new ConceptEditorHintImpl("Diagrammatic", "Diagrammatic", true, "StateMachine.editor.StateMachineHints.Diagrammatic"), new ConceptEditorHintImpl("Tabular", "Tabular", true, "StateMachine.editor.StateMachineHints.Tabular"), new ConceptEditorHintImpl("Textual", "Textual", true, "StateMachine.editor.StateMachineHints.Textual"));
  @NotNull
  ...
  private Collection<ConceptEditorComponent> getDeclaredEC_0(String editorComponentId) {
    switch (editorComponentId) {
      case "StateMachine.editor.StateMachineDiagramContents":
        return Collections.singletonList(new StateMachineDiagramContents());
      case "StateMachine.editor.StateMachineTextContents":
