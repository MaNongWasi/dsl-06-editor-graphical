...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptIStateMachineContents = createDescriptorForIStateMachineContents();
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptEvent, myConceptIStateMachineContents, myConceptState, myConceptStateMachine, myConceptTransition);
  }
  ...
  public ConceptDescriptor getDescriptor(SConceptId id) {
    switch (myIndexSwitch.index(id)) {
      ...
      case LanguageConceptSwitch.IStateMachineContents:
        return myConceptIStateMachineContents;
  ...
  private static ConceptDescriptor createDescriptorForEvent() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("StateMachine", "Event", 0xdac36cdfb92546cfL, 0x8a2c2b6a1b73035cL, 0x51c6850f8a2fce2dL);
    b.class_(false, false, false);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.origin("r:3177cfff-838c-465b-a99f-733b3486f4ac(StateMachine.structure)/5892543464250265133");
    b.version(2);
    b.alias("event");
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForIStateMachineContents() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("StateMachine", "IStateMachineContents", 0xdac36cdfb92546cfL, 0x8a2c2b6a1b73035cL, 0x6b05dff7a3efd459L);
    b.interface_();
    b.origin("r:3177cfff-838c-465b-a99f-733b3486f4ac(StateMachine.structure)/7711816191642162265");
    b.version(2);
  ...
  private static ConceptDescriptor createDescriptorForState() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("StateMachine", "State", 0xdac36cdfb92546cfL, 0x8a2c2b6a1b73035cL, 0x51c6850f8a2fce2cL);
    b.class_(false, false, false);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.parent(0xdac36cdfb92546cfL, 0x8a2c2b6a1b73035cL, 0x6b05dff7a3efd459L);
    b.origin("r:3177cfff-838c-465b-a99f-733b3486f4ac(StateMachine.structure)/5892543464250265132");
    b.version(2);
    b.property("isInitial", 0x6b05dff7a3dddcd8L).type(PrimitiveTypeId.BOOLEAN).origin("7711816191640984792").done();
    b.property("isFinal", 0x6b05dff7a3e78434L).type(PrimitiveTypeId.BOOLEAN).origin("7711816191641617460").done();
    b.alias("state");
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForStateMachine() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("StateMachine", "StateMachine", 0xdac36cdfb92546cfL, 0x8a2c2b6a1b73035cL, 0x51c6850f8a2fce29L);
    b.class_(false, false, true);
    b.parent(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L);
    b.parent(0xdac36cdfb92546cfL, 0x8a2c2b6a1b73035cL, 0x6b05dff7a3efd459L);
    b.origin("r:3177cfff-838c-465b-a99f-733b3486f4ac(StateMachine.structure)/5892543464250265129");
    b.version(2);
    b.alias("statemachine");
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForTransition() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("StateMachine", "Transition", 0xdac36cdfb92546cfL, 0x8a2c2b6a1b73035cL, 0x51c6850f8a2fce2eL);
    b.class_(false, false, false);
    b.origin("r:3177cfff-838c-465b-a99f-733b3486f4ac(StateMachine.structure)/5892543464250265134");
    b.version(2);
